...
const scenes: Record<string, Scene> = {
  ...
  find_kitten: {
    ...
    character: 'Аффогато',
    text: 'Из-под заснеженного куста выглядывает маленький чёрный котёнок. Он дрожит от холода, его большие глаза смотрят на тебя с мольбой. «Что это?» — король хмурится. «Животное. В моём саду.» Котёнок жалобно мяукает.',
    choices: [
  ...
  king_tenderness: {
    ...
    character: 'Дарк Какао',
    text: 'Король ведёт тебя обратно в замок, его рука нежно лежит на твоей спине. «Знаешь... я никогда не думал, что смогу чувствовать себя так спокойно.» Он останавливается, поворачиваясь к тебе. «С тобой я не чудовище. Я просто... я.» В его глазах читается уязвимость.',
    choices: [
  ...
  king_gift: {
    ...
    character: 'Дарк Какао',
    text: 'На следующее утро король ведёт тебя в свою сокровищницу. «Выбирай,» — говорит он. «Всё, что здесь — твоё.» Драгоценности, артефакты, древнее оружие. «Но знай — самое драгоценное сокровище уже моё.» Он смотрит на тебя. «Ты.»',
    choices: [
  ...
  choose_gift: {
    ...
    background: 'bg-gradient-to-b from-purple-950 via-indigo-900 to-black',
    character: 'Дарк Какао',
    text: 'Ты выбираешь украшение — кольцо с чёрным бриллиантом. Король берёт его и надевает на твой палец сам. «Теперь все будут знать, что ты принадлежишь мне.» Он целует твою руку. «Моё королевство, моя корона, моя жизнь — всё это ничто без тебя.»',
    choices: [
  ...
  ending_perfect_love: {
    ...
    text: 'Твои отношения с Дарк Какао трансформируются. Его одержимость никуда не исчезла, но теперь она сбалансирована твоей искренней привязанностью. Он всё ещё ревнует, всё ещё одержим, но теперь ты понимаешь это и принимаешь. Королевство процветает под его правлением, потому что у него есть причина быть лучше — ты. По утрам вы гуляете в зимнем саду, держась за руки. Это нездоровая любовь? Возможно. Но она ваша. И для вас двоих — она идеальна.',
    isEnding: true
  },
  ending_obsession: {
    id: 'ending_obsession',
